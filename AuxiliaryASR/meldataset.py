...
# _ROOT_WAVS = "/mnt/f/MASTER/PROJECT/RDSpeech/wavs"
# _ROOT_WAVS = "/content/drive/MyDrive/RDSpeech/wavs"
_ROOT_WAVS = "./wavs"
...
class MelDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if wave_tensor.dim() > 1:
            wave_tensor = torch.mean(wave_tensor, dim=1, keepdim=False)
    ...
    def _load_tensor(self, data):
        ...
        wave, sr = sf.read(osp.join(_ROOT_WAVS, wave_path))
